...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Mortal Kombat 4",
    .project_root_env = "MORTAL_KOMBAT_4_PROJECT_ROOT",
    .build_dir_env = "MORTAL_KOMBAT_4_BUILD_DIR",
    .force_setup_env = "MORTAL_KOMBAT_4_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_006.05_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Mortal_Kombat_4",
    .prepare_note =
